    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
        ...
        <div className='flex-1'>
            <div className="flex items-center mb-1 ">
                ...
                <span className='text-gray'>{moment(comment.createdAt).fromNow()}</span>
            ...
            isEditing ? (
               ...
               <>
                ...
                <div className="flex  items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
                    <button onClick={()=>{onLike(comment._id)}} type='button' className={`text-gray-400 ${currentUser && comment.likes.includes(currentUser._id) && "!text-blue-500" }`}><FaThumbsUp/></button>
               <p className='text-gray-400'>
                ...
                currentUser && (currentUser._id === comment.userId ||  currentUser.isAdmin) && (
                    ...
                    <button onClick={()=>{onDelete(comment._id)}} className='text-red-400 hover:text-blue-500'>Delete</button>
