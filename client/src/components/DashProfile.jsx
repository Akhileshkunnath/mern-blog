  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      styles={{
       ...
       <img src={imageFileUrl || currentUser.profilePicture} alt="user"  className={`rounded-full w-full h-full border-8 object-cover border-[lightgray] ${imageFileUploadProgress && imageFileUploadProgress < 100 && "opacity-60"}`}/>
       ...
       <Button type="submit" className="" gradientDuoTone={"purpleToBlue"} outline disabled={loading || imageFileUploading}>
       ...
       <div className="text-red-500 flex justify-between mt-5">
        <span onClick={()=>{setShowModal(true)}} className="hover:cursor-pointer">Delete Account</span>
