...
import { HiAnnotation, HiArrowNarrowUp, HiDocumentText, HiOutlineArrowNarrowUp, HiOutlineUserGroup } from 'react-icons/hi';
          ...
          <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-2 text-sm">
                        <span className="text-green-500 flex items-center"><HiOutlineArrowNarrowUp/>{lastMonthUsers}</span>
            ...
            <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-2 text-sm">
                        <span className="text-green-500 flex items-center"><HiOutlineArrowNarrowUp/>{lastMonthComments}</span>
                        <div className='text-gray-500'>last month</div>
            ...
            <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-2 text-sm">
                        <span className="text-green-500 flex items-center"><HiOutlineArrowNarrowUp/>{lastMonthPosts}</span>
                        <div className='text-gray-500'>last month</div>
                        ...
                        users && users.map((user)=>(
                            <Table.Body key={user._id} className='divide-y'>
                                <Table.Row className='bg-white dark:bg-gray-800 dark:border-gray-700' >
                                      <Table.Cell>
                                        <img
                                        src={user.profilePicture} alt='user' className='w-10 h-10 rounded-full bg-gray-500'
                                        />
                                      </Table.Cell>
                                      <Table.Cell>
                                        {user.username}
                        ...
                        posts && posts.map((post)=>(
                            <Table.Body key={post._id} className='divide-y'>
                                <Table.Row className='bg-white dark:bg-gray-800 dark:border-gray-700' >
                                      <Table.Cell>
                                        <img
                                        src={post.image} alt='user' className='w-14 h-10 rounded-md bg-gray-500'
                                        />
                                      </Table.Cell>
                                      <Table.Cell className='w-96'>
                                        {post.title}
